...
var SeriesContainer = function (_React$Component2) {
  _inherits(SeriesContainer, _React$Component2);
  ...
  _createClass(SeriesContainer, [{
    ...
    value: function render() {
      ...
      try {
        for (var _iterator = this.props.xVals[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var xVal = _step.value;
...
var LineChartResponsive = function (_React$Component4) {
  _inherits(LineChartResponsive, _React$Component4);

  function LineChartResponsive() {
    _classCallCheck(this, LineChartResponsive);

    return _possibleConstructorReturn(this, (LineChartResponsive.__proto__ || Object.getPrototypeOf(LineChartResponsive)).apply(this, arguments));
  }

  _createClass(LineChartResponsive, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        _replotCore.Resize,
        { width: this.props.width },
        _react2.default.createElement(LineChart, this.props)
      );
    }
  }]);

  return LineChartResponsive;
}(_react2.default.Component);
...
LineChart.propTypes = {
  ...
  graphTitle: _propTypes2.default.string,
...
var _Motion = __webpack_require__(25);
