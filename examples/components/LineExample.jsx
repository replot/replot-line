  ...
  constructor(props){
    ...
    this.state = {
      optionList: [
        ...
        {optionName: "xTitle", name: "X Title", optionType: "field", input: "string", initialValue: "Year"},
        {optionName: "yTitle", name: "Y Title", optionType: "field", input: "string", initialValue: "Value"},
        ...
        {optionName: "graphTitleColor", name: "Title Color", optionType: "field", input: "string", initialValue: colors[this.props.palette].axisColor},
